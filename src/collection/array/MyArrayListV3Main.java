...
public class MyArrayListV3Main {
    public static void main(String[] args) {
        ...
        System.out.println("remove(4)=" + removed1); // 마지막 값 삭제 O(1)
        System.out.println(list);
        Object removed2 = list.remove(0);
        System.out.println("remove(0)=" + removed2); // 첫 번째 값 삭제 O(n)
        System.out.println(list);
    }
}
/*
    지금까지 우리가 만든 자료 구조를 배열 리스트(ArrayList)라 한다.
    리스트(List) 자료 구조를 사용하는데, 내부의 데이터는 배열에 보관하는 것이다.
    ...
    배열 리스트는 마지막에 데이터를 추가하거나 마지막에 있는 데이터를 삭제할 때 O(1)로 매우 빠르지만,
